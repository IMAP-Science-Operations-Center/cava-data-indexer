...
class PspDirectoryInfo:
    ...
    def __eq__(self, other):
        return (
            ...
            and self.instrument_human_readable == other.instrument_human_readable
            and self.instrument_url == other.instrument_url
            and self.file_infos_by_mode == other.file_infos_by_mode
            and self.variable_selector == other.variable_selector
            and self.mission == other.mission
            and self.file_cadence.name == other.file_cadence.name
        )
...
class PspDownloader:
    ...
    def get_all_metadata() -> List[PspDirectoryInfo]:
        psp_filenames = [
            PspDownloader._get_metadata_for_multiple_data_sets(
                psp_isois_cda_base_url, "ISOIS-EPIHi", "epihi", DefaultVariableSelector, "PSP", DailyFileCadence()
            ),
            PspDownloader._get_metadata_for_multiple_data_sets(
            ...
            PspDownloader._get_metadata_for_multiple_data_sets(
                psp_isois_cda_base_url, "ISOIS", "merged", DefaultVariableSelector, "PSP", DailyFileCadence()
            ),
            PspDownloader._get_metadata_for_one_data_set(
            ...
            PspDownloader._get_metadata_for_one_data_set(
                omni_cda_base_url, "OMNI", "hourly", OmniVariableSelector, "OMNI", SixMonthFileCadence()
            ),
        ]
    ...
    @staticmethod
    def _get_metadata_for_multiple_data_sets(
        base_url: str,
        instrument_human_readable: str,
        detector_url: str,
        variable_selector: type[VariableSelector],
    ...
    @staticmethod
    def _get_metadata_for_one_data_set(
        base_url: str,
        instrument_human_readable: str,
        detector_url: str,
        variable_selector: type[VariableSelector],
