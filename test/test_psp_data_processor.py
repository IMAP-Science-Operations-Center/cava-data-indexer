...
class TestPspDataProcessor(unittest.TestCase):
    ...
    def test_gets_filenames_and_downloads_the_first_file_in_list(
        self, mock_get_with_retry, mock_downloader, mock_cdf_parser
    ):
        self.maxDiff = None
        mock_downloader.get_all_metadata.return_value = [
            PspDirectoryInfo(
                ...
                {
                    "het_rate1": [
                        PspFileInfo("link1", "psp_isois-epihi_l2-het-rates3600_20190102_v9.cdf", "2022"),
                    ...
                    "het_rate2": [
                        PspFileInfo("link3", "psp_isois-epihi_l2-het-rates60_20190102_v11.cdf", "2023"),
                        PspFileInfo("link4", "psp_isois-epihi_l2-het-rates60_20190105_v12.cdf", "2023"),
                    ],
                },
                sentinel.variable_selector_1,
                "PSP",
                DailyFileCadence(),
            ),
            PspDirectoryInfo(
                ...
                {
                    "ephem": [
                        PspFileInfo("linkfile_to_download5.cdf", "psp_isois_l2-ephem_20181111_v12.cdf", "2022"),
                        PspFileInfo("linkfile_to_download6.cdf", "psp_isois_l2-ephem_20181112_v12.cdf", "2022"),
                    ],
                    "summary": [
                        PspFileInfo("linkfile_to_download7.cdf", "psp_isois_l2-summary_20181114_v13.cdf", "2023"),
        ...
        mock_downloader.get_url.assert_has_calls(
            [
                call(
                    psp_isois_cda_base_url,
                    "psp_isois-epihi_l2-het-rates3600_20190102_v10.cdf",
                    "epihi",
                    "het_rate1",
                    "2022",
                ),
                call(
                    psp_isois_cda_base_url,
                    "psp_isois-epihi_l2-het-rates3600_20190103_v10.cdf",
                    "epihi",
                    "het_rate1",
                    "2022",
                ),
                call(
                    psp_isois_cda_base_url,
                    "psp_isois-epihi_l2-het-rates60_20190102_v11.cdf",
                    "epihi",
                    "het_rate2",
                    "2023",
                ),
                call(
                    psp_isois_cda_base_url,
                    "psp_isois-epihi_l2-het-rates60_20190105_v12.cdf",
                    "epihi",
                    "het_rate2",
                    "2023",
                ),
            ...
            [
                {
                    "variables": [
                        {
                            "catalog_description": "a description v1",
                ...
                },
                {
                    "variables": [
                        {
                            "catalog_description": "a description v2",
                            "display_type": "time_series",
                ...
                },
                {
                    "variables": [
                        {
                            "catalog_description": "a description v3",
                            "display_type": "time_series",
                ...
                },
                {
                    "variables": [
                        {
                            "catalog_description": "a description v4",
                            "display_type": "time_series",
