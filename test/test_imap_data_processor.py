...
from src.imap_data_processor import group_metadata_by_file_names, _parse_variables_from_cdf, \
    parse_variables_from_cdf_bytes, \
    get_metadata_index
...
class TestImapDataProcessor(TestCase):
    ...
    @patch('src.imap_data_processor.pycdf')
