...
class TestPspFileParser(TestCase):
    ...
    def test_retrieves_list_of_files_for_types(self, mock_get_with_retry):
        ...
        mock_get_with_retry.side_effect = [
            mock_l2_response,
            mock_het_rate_1_response,
            mock_2022_response,
            mock_het_rate_2_response,
            mock_2022_r2_response,
            mock_2023_response,
        ]
        ...
        expected_file_dictionary = {
            "het_rate_1/": [
                PspFileInfo(
                    "psp_isois-epihi_l2-het-rate1_20220928_v13.cdf",
                    "psp_isois-epihi_l2-het-rate1_20220928_v13.cdf",
                    "2022",
                ),
                PspFileInfo(
            ...
            "het_rate_2/": [
                PspFileInfo(
                    "psp_isois-epihi_l2-het-rate2_20220928_v13.cdf",
                    "psp_isois-epihi_l2-het-rate2_20220928_v13.cdf",
                    "2022_rate2",
                ),
                PspFileInfo(
                ...
                PspFileInfo(
                    "psp_isois-epihi_l2-het-rate2_20230928_v13.cdf",
                    "psp_isois-epihi_l2-het-rate2_20230928_v13.cdf",
                    "2023",
                ),
                PspFileInfo(
                    "psp_isois-epihi_l2-het-rate2_20230929_v13.cdf",
                    "psp_isois-epihi_l2-het-rate2_20230929_v13.cdf",
                    "2023",
                ),
            ],
