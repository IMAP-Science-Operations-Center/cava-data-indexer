...
from data_indexer.cdf_downloader.psp_downloader import (
    PspDirectoryInfo,
    PspDownloader,
    omni_cda_base_url,
    psp_fields_cda_base_url,
    psp_isois_cda_base_url,
)
...
class TestPspDownloader(TestCase):
    ...
    def test_download_psp_data_from_cda_web(self, mock_psp_file_parser: PspFileParser):
        epihi_filenames = {
            "het_rate_1/": [
                PspFileInfo("psp_isois-epihi_l2-het-rate1_20220928_v13.cdf", "name", "1998"),
                PspFileInfo("psp_isois-epihi_l2-het-rate1_20220929_v13.cdf", "name", "1999"),
            ],
            "het_rate_2/": [
                PspFileInfo("psp_isois-epihi_l2-het-rate2_20220928_v13.cdf", "name", "2000"),
                PspFileInfo("psp_isois-epihi_l2-het-rate2_20220929_v13.cdf", "name", "2001"),
            ],
        }

        epilo_filenames = {
            "ic": [PspFileInfo("epilo_1.cdf", "name5", "2002"), PspFileInfo("epilo_2.cdf", "name6", "2003")],
        }
        ...
        fields_4_per_cycle_filenames = {
            "": [
                PspFileInfo(
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20230101_v02.cdf",
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20230101_v02",
                    "2023",
                ),
                PspFileInfo(
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20230102_v02.cdf",
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20230102_v02",
                    "2023",
                ),
                PspFileInfo(
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20220101_v02.cdf",
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20220101_v02",
                    "2022",
                ),
                PspFileInfo(
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20220102_v02.cdf",
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20220102_v02",
                    "2022",
                ),
                PspFileInfo(
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20210101_v02.cdf",
                    "psp_fld_l2_mag_rtn_4_sa_per_cyc_20210101_v02",
                    "2021",
                ),
            ]
        }
        ...
        expected_metadata = [
            ...
            PspDirectoryInfo(
                omni_cda_base_url, "OMNI", "hourly", omni_filenames, OmniVariableSelector, "OMNI", SixMonthFileCadence()
            ),
        ]

        self.assertEqual(expected_metadata, metadata)
        mock_psp_file_parser.get_dictionary_of_files.assert_any_call(
            "https://cdaweb.gsfc.nasa.gov/pub/data/psp/isois/epihi/l2/"
        )
        mock_psp_file_parser.get_dictionary_of_files.assert_any_call(
    ...
    def test_download_individual_file(self, mock_get_with_retry):
        ...
        response = PspDownloader.get_cdf_file(
            psp_isois_cda_base_url, "psp_isois-epihi_l2-het-rate1_20220928_v13.cdf", "epihi", "het-rate1/", "2022"
        )
