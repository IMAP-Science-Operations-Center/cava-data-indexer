...
class TestCdfVariableParser(unittest.TestCase):
    ...
    def test_parse_variables_from_cdf_bytes_filter_out_variables_that_are_missing_key_features(self, mock_CDF_class):
        ...
        expected_descriptions = {'var_not_filtered v99': "var0"}
        ...
        var_filtered_for_linear_scaletype_and_scalemin_nonzero = Mock()
        var_filtered_for_linear_scaletype_and_scalemin_nonzero.attrs = {
            "CATDESC": "var_filtered",
            "VAR_TYPE": "data",
            "FIELDNAM": "something",
            "DEPEND_0": "time_col_good",
        ...
        var_filtered_for_linear_scaletype_and_scalemin_nonzero.shape = (1, 2)
        ...
        var_filtered_for_scaletype_log_and_scalemin_nonzero = Mock()
        var_filtered_for_scaletype_log_and_scalemin_nonzero.attrs = {
            "CATDESC": "var_filtered",
            "VAR_TYPE": "data",
            "FIELDNAM": "something",
            "DEPEND_0": "time_col_good",
        ...
        var_filtered_for_scaletype_log_and_scalemin_nonzero.shape = (1, 2)
        ...
        var_filtered_for_scaletype_missing_and_scalemin_nonzero = Mock()
        var_filtered_for_scaletype_missing_and_scalemin_nonzero.attrs = {
            "CATDESC": "var_filtered",
            "VAR_TYPE": "data",
            "FIELDNAM": "something",
            "DEPEND_0": "time_col_good",
        ...
        var_filtered_for_scaletype_missing_and_scalemin_nonzero.shape = (1, 2)
        ...
        mock_cdf_instance.items.return_value = {
            ...
            'var5': var_filtered_for_linear_scaletype_and_scalemin_nonzero,
            'var6': var_filtered_for_scaletype_log_and_scalemin_zero,
            'var7': var_filtered_for_scaletype_log_and_scalemin_nonzero,
            'var8': var_filtered_for_scaletype_missing_and_scalemin_zero,
            'var9': var_filtered_for_scaletype_missing_and_scalemin_nonzero,
        }.items()

        mock_time_column_good = Mock()
        mock_time_column_good.attrs = {'DELTA_MINUS_VAR', 'DELTA_PLUS_VAR'}
        mock_time_col_no_delta_minus = Mock()
        mock_time_col_no_delta_minus.attrs = {'DELTA_PLUS_VAR'}
        mock_time_col_no_delta_plus = Mock()
        mock_time_col_no_delta_plus.attrs = {'DELTA_MINUS_VAR'}
        cdf_items = {'time_col_good': mock_time_column_good, 'time_col_no_delta_minus': mock_time_col_no_delta_minus, 'time_col_no_delta_plus': mock_time_col_no_delta_plus}
