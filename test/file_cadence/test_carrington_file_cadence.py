...
class TestCarringtonFileCadence(unittest.TestCase):
    def test_get_file_time_range_with_start_date(self):
        cases = [
            (
                datetime(1853, 10, 13, tzinfo=timezone.utc),
                datetime(1853, 10, 13, 14, tzinfo=timezone.utc),
                datetime(1853, 11, 9, 21, tzinfo=timezone.utc),
            ),
            (
                datetime(2025, 6, 19, tzinfo=timezone.utc),
                datetime(2025, 6, 19, 12, tzinfo=timezone.utc),
                datetime(2025, 7, 16, 17, tzinfo=timezone.utc),
            ),
        ]
